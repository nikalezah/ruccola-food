...
/**
 * Material 3 window width size classes. Used across the apps to decide how to lay out content for
 * the available width (phone vs. tablet vs. desktop / wide browser window).
 *
...
/**
 * Provides the current [WindowWidthClass] to the composition. It is set once by
 * [AdaptiveNavigationScaffold] (the root of each authenticated screen) so any nested screen can read
 * it without measuring the window again.
 */
